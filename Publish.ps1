...
New-Item "./Publishing/PSWinRAR" -ItemType Directory -Force | Out-Null
...
Publish-Module -Path ./Publishing/PSWinRAR -NuGetApiKey $ApiKey -Repository "CustomRepository" -ErrorAction "continue"
...
Remove-Item "./Publishing" -Recurse -Force | Out-Null